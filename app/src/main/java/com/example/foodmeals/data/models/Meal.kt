...
*/
@Entity
data class Meal(@PrimaryKey @SerializedName(value = "idMeal",alternate = ["idDrink"])val idMeal:Long,
                @SerializedName(value = "strMeal",alternate = ["strDrink"])val strMeal:String?, val strCategory:String,
